            ...
            <div class="posts-item posts-item-gallery">
                ...
                <div class="item-info">
                    <ul>
                        ...
                        <li class="ico-eye hidden-xs"><i class="icon-book-open" style="height: 20px;line-height: 20px;"></i>${row.views}</li>
                        <li class="ico-like hidden-xs"><i class="icon-bubble" style="height: 20px;line-height: 20px;"></i>${row.comments}</li>
                    </ul>
                </div>
            </div>
        </div>
